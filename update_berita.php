          ...
          <div class="col-md-12">
                         <div class="card">
                           ...
                           <div class="card-body">
                             ...
                             <?php
                             $result = mysqli_query($conn, $results = mysqli_query($conn, "SELECT * FROM berita = $_GET[id] ORDER BY id_berita DESC"));
                             ...
                             ?>
                                  ...
                                  <form role="form" method="POST" action="proses_update_berita.php"enctype="multipart/form-data">
                                                ...
                                                <select name="kategori" class="form-control select2" data-placeholder="Pilih Kategori">
                                                  ...
                                                  $gets = mysqli_query($conn, "SELECT group_concat(k.id_kategori) as id_kat FROM kategori k join berita b on(k.id_kategori=b.id_kategori) where b.id_berita='$rows[id_berita]'");
                                                  ...
                                                  while($row = mysqli_fetch_array($results, MYSQLI_ASSOC))
                                                        {
                                                          if (ucwords($_SESSION['nama_kategori']) == ucwords($row['nama_kategori'])) {
                                                             ...
                                                             $option .= '<option '.$selected.' value = "'.$row['id_kategori'].'">'.$row['nama_kategori'].'</option>';
                                                           }
                                                        }
                                                  ?>
                                                  <?php echo $option; ?>
                                                ...
                                                <div class="form-group row">
                                                <div class="col-sm-2 col-form-label"><label for="exampleInputIsi">Isi</label></div><div class="col-sm-10"> <textarea required class="form-control" id="isi" placeholder="Masukan Isi Berita" name="isi"><?php echo $rows['isi']; ?></textarea></div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                  ...
                                                  <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                        ...
                                                        <input  required type="text" class="form-control  datepicker" name="tanggal" value="<?php echo date("m/d/Y", strtotime($rows['tanggal'])); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                  <div class="form-group row">
