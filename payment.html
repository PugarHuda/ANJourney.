        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="steps">
              ...
              <p>Please provide all the information of the person who is going to be making the transaction..</p>
          ...
          <!-- end col-8 -->
          <button type="submit" class="site-btn pull-right">MAKE PAYMENT</button>
        </div>
        <!-- end row -->
      </div>
      <!-- end container -->
