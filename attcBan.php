      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            ...
            <p>
              Bandung tidak hanya sekadar destinasi wisata, tetapi juga merupakan pengalaman yang menggugah selera, mengasyikkan, dan menghidupkan semangat petualangan Anda. Jelajahi keindahan kota ini dan nikmati setiap momen di Bandung,
...
$sql = "SELECT detailwisata.*, detailtour.* 
        ...
        WHERE detailtour.namaKota = 'Bandung'
