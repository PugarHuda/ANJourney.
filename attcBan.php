...
<body>
    ...
    <section class="attractions-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Bandung Attractions</h2>
                    <img src="images/title-seperator.png" alt="Image" />
                    <p>
                        Bandung tidak hanya sekadar destinasi wisata, tetapi juga merupakan pengalaman yang menggugah
                        selera, mengasyikkan, dan menghidupkan semangat petualangan Anda. Jelajahi keindahan kota ini
                        dan nikmati setiap momen di Bandung,
                        di mana keaslian, keindahan alam, dan keramahan menyatu dalam satu kesempurnaan.
                    </p>
                </div>
                <!-- end col-12 -->
            </div>
    ...
    <div class="attractions-hero-image bg-image" data-background="images/slide1.jpg"></div>
