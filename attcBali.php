            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p>
                            Selain pantainya yang menawan, Bali juga terkenal dengan keberagaman budayanya. Ada
                            kuil-kuil Hindu yang indah seperti Pura Tanah Lot, Pura Besakih, dan Pura Ulun Danu Bratan
                            yang mempesona dengan arsitektur dan keindahan alam
                            sekitarnya. Upacara keagamaan dan tari-tarian tradisional seperti Kecak, Barong, atau Legong
                            menjadi cerminan dari warisan budaya yang kaya di pulau ini.
                        </p>
                    </div>
                    <!-- end col-12 -->
                </div>
