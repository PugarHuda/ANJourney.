      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- end info-box -->
            <div class="info-box">Price: <strong>$278.42</strong></div>
            <!-- end info-box -->
          </div>
          <!-- end col-12 -->
        </div>
              ...
              <div class="accordion" id="accordion">
                <div class="card">
                  <div class="card-header" id="headingOne">
                    <a data-toggle="collapse" href="#collapseOne" aria-expanded="true"><strong>PASSENGER 1:</strong> Adult (16 - 99)</a>
                  </div>
                                ...
                                <div class="form-group">
                                  <div class="currency dropdown selectdrop">
                                    <a href="#" data-toggle="dropdown" class="selection"
                                      >Select Size<span class="arrow"><i class="fa fa-angle-down"></i></span
                                    ></a>
                                    <ul class="dropdown-menu">
                                      <li><a>Small</a></li>
                                      <li><a>Medium</a></li>
                ...
                <div class="card">
                  <div class="card-header" id="headingTwo">
                    <a class="collapsed" data-toggle="collapse" href="#collapseTwo"><strong>PASSENGER 2:</strong> Adult (16 - 99) </a>
                  </div>
                ...
                <div class="card">
                  <div class="card-header" id="headingThree">
                    <a class="collapsed" data-toggle="collapse" href="#collapseThree"><strong>PASSENGER 3:</strong> Adult (16 - 99) </a>
                  </div>
