  ...
  <body>
    ...
    <section class="attractions-header">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h2>Jakarta Attractions</h2>
            <img src="images/title-seperator.png" alt="Image" />
            <p>
              Salah satu daya tarik utama Jakarta adalah keragaman budayanya. Kota ini menawarkan beragam situs sejarah, seperti Kota Tua yang memesona, di mana Anda dapat merasakan sentuhan masa lalu melalui bangunan-bangunan peninggalan
              kolonial Belanda. Selain itu, Museum Nasional dan Museum Seni Modern dan Kontemporer menampilkan kekayaan warisan budaya Indonesia yang luar biasa.
            </p>
          </div>
          <!-- end col-12 -->
        </div>
